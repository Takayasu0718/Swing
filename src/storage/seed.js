...
const DEMO_TEAMS = [
  { name: 'イースタンボーイズ', description: '東エリアの強豪チーム', captain: { nickname: 'だいき', avatarStamp: 'boy_cheer', dailyGoal: 150 } },
  { name: '羽沢フォースターズ', description: '四つ星の意志で勝つ！', captain: { nickname: 'そうご', avatarStamp: 'boy_wink', dailyGoal: 100 } },
  { name: 'ブルーフェニックス', description: '青い炎のチーム', captain: { nickname: 'れん', avatarStamp: 'boy_fire', dailyGoal: 125 } },
]

// Sakuradai Sunbird roster — all 16 are friends of the current user AND teammates.
const SUNBIRD_ROSTER = [
  { nickname: 'りくた', avatarStamp: 'boy_cheer', dailyGoal: 100 },
  { nickname: 'けい', avatarStamp: 'boy_wink', dailyGoal: 75 },
  { nickname: 'みもり', avatarStamp: 'girl_cheer', dailyGoal: 125 },
  { nickname: 'ほくと', avatarStamp: 'boy_fire', dailyGoal: 50 },
  { nickname: 'えいた', avatarStamp: 'boy_cheer', dailyGoal: 150 },
  { nickname: 'りんたろう', avatarStamp: 'boy_wink', dailyGoal: 100 },
  { nickname: 'そうた', avatarStamp: 'boy_fire', dailyGoal: 75 },
  { nickname: 'はじめ', avatarStamp: 'boy_cheer', dailyGoal: 100 },
  { nickname: 'ちなつ', avatarStamp: 'girl_wink', dailyGoal: 50 },
  { nickname: 'ゆう', avatarStamp: 'girl_fire', dailyGoal: 75 },
  { nickname: 'こう', avatarStamp: 'boy_cheer', dailyGoal: 150 },
  { nickname: 'そら', avatarStamp: 'girl_cheer', dailyGoal: 100 },
  { nickname: 'いつき', avatarStamp: 'boy_wink', dailyGoal: 125 },
  { nickname: 'かい', avatarStamp: 'boy_fire', dailyGoal: 75 },
  { nickname: 'そう', avatarStamp: 'boy_cheer', dailyGoal: 100 },
  { nickname: 'けんた', avatarStamp: 'boy_wink', dailyGoal: 100 },
]
