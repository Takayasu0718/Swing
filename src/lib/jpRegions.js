// 47都道府県と主要市町村のリスト。全市町村の網羅は重いため、政令指定都市・中核市・
// 県庁所在地・主要市を含む実用的サブセット。それ以外は「その他（直接入力）」で対応。
...
export const MUNICIPALITIES_BY_PREF = {
  '北海道': ['札幌市', '函館市', '小樽市', '旭川市', '室蘭市', '釧路市', '帯広市', '北見市', '夕張市', '岩見沢市', '網走市', '苫小牧市', '稚内市', '美唄市', '芦別市', '江別市', '赤平市', '紋別市', '士別市', '名寄市', '三笠市', '根室市', '千歳市', '滝川市', '砂川市', '歌志内市', '深川市', '富良野市', '登別市', '恵庭市', '伊達市', '北広島市', '石狩市', '北斗市'],
...
export const OTHER_OPTION = 'その他（直接入力）'
